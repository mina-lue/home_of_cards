  ...
  return (
    <section className="bg-white py-20">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Grading Guide</h2>
        <p className="text-base md:text-lg text-gray-600 mb-10">Understand how your cards are graded with our comprehensive guide.</p>

        <div className="flex flex-wrap justify-center gap-2 md:space-x-4 mb-8">
        ...
        <div className="flex flex-wrap justify-center gap-2 md:space-x-4 mb-10">
        ...
        <Image src="https://via.placeholder.com/500x300" alt="Grading Guide" width={500} height={300} className="mx-auto rounded-md" />
      </div>
    </section>
  );
}
