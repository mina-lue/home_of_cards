  ...
  return (
    <section className="bg-gray-100 py-20">
      <div className="container mx-auto px-4 text-center">
        <h1 className="text-5xl font-bold text-gray-800 leading-tight mb-4">Your Collection, Your Tools,<br />Your Community</h1>
        <p className="text-xl text-gray-600 mb-8">Discover, organize, and value your card collection with ease.</p>
        <div className="flex justify-center space-x-4">
          <button className="bg-red-600 text-white px-8 py-3 rounded-full text-lg hover:bg-red-700">Explore Cards</button>
          <button className="bg-gray-800 text-white px-8 py-3 rounded-full text-lg hover:bg-gray-900">Learn More</button>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="flex justify-center space-x-4 mb-4">
              <Image src="/card-placeholder.png" alt="Card" width={80} height={120} />
              <Image src="/card-placeholder.png" alt="Card" width={80} height={120} />
            </div>
            <div className="mt-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
            ...
            <Image src="/card-placeholder.png" alt="Card" width={120} height={180} className="mb-4" />
          ...
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
            ...
            <Image src="/chart-placeholder.png" alt="Grading Chart" width={150} height={100} className="mb-4" />
