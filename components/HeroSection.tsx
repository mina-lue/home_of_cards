        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="flex justify-center space-x-4 mb-4">
              <Image src="https://via.placeholder.com/80x120" alt="Card" width={80} height={120} />
              <Image src="https://via.placeholder.com/80x120" alt="Card" width={80} height={120} />
            </div>
            <div className="mt-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
            ...
            <Image src="https://via.placeholder.com/120x180" alt="Card" width={120} height={180} className="mb-4" />
          ...
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
            ...
            <Image src="https://via.placeholder.com/150x100" alt="Grading Chart" width={150} height={100} className="mb-4" />
