  ...
  return (
    <section className="bg-red-600 py-20 text-white">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold mb-10">Calendar</h2>

        <div className="flex flex-col md:flex-row justify-between items-center mb-10 space-y-4 md:space-y-0">
          <div className="flex space-x-4">
            <button className="bg-white text-red-600 px-6 py-2 rounded-full hover:bg-gray-100">Set Release Calendar</button>
            <button className="bg-white text-red-600 px-6 py-2 rounded-full hover:bg-gray-100">Event Calendar</button>
          </div>
          <div className="flex space-x-4">
            <input type="text" placeholder="Search" className="px-4 py-2 rounded-full text-gray-800" />
            <select className="px-4 py-2 rounded-full text-gray-800">
              <option>Year</option>
            </select>
            <select className="px-4 py-2 rounded-full text-gray-800">
            ...
            <button className="bg-white text-red-600 px-6 py-2 rounded-full hover:bg-gray-100">Search Event</button>
          </div>
        </div>
