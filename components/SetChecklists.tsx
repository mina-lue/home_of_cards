    ...
    <section className="bg-gray-100 py-20">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-10">
          <h2 className="text-4xl font-bold text-gray-800">Set Checklists</h2>
          <button className="bg-red-600 text-white px-6 py-2 rounded-full hover:bg-red-700">Filter</button>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Set Card 1 */}
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
            <Image src="/set-placeholder.png" alt="Set Image" width={200} height={150} className="rounded-md mb-4" />
